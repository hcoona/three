...
[![License: LGPL-3.0-or-later WITH LGPL-3.0-linking-exception](https://img.shields.io/badge/License-LGPL--3.0--or--later%20WITH%20LGPL--3.0--linking--exception-blue.svg)](https://dev.azure.com/zhangshuai89/Public/_git/OneDotNet?path=/LICENSE.LGPLv3-linking-exception.txt)
