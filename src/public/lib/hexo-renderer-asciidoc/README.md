...
4. Use the retained root workflow entrypoint `.github/workflows/official.yml` for release orchestration. The legacy `.github/workflows/buddy.yml` and `.github/workflows/release-buddy.yml` entries are retired with no compatibility route.
