...
This project is licensed under the GNU General Public License v3.0 or later (GPL v3+). See [COPYING](https://github.com/hcoona/three/blob/main/COPYING) for details.

The NuGet package is distributed under the terms of LGPL-3.0-or-later WITH LGPL-3.0-linking-exception. See [COPYING.LESSER](https://github.com/hcoona/three/blob/main/COPYING.LESSER) and the [linking exception](https://github.com/hcoona/three/blob/main/LICENSES/LGPL-3.0-linking-exception.txt) for details.
...
- [COPYING](https://github.com/hcoona/three/blob/main/COPYING) (GPL v3+)
- [COPYING.LESSER](https://github.com/hcoona/three/blob/main/COPYING.LESSER) and [linking exception](https://github.com/hcoona/three/blob/main/LICENSES/LGPL-3.0-linking-exception.txt) (LGPL v3.0 with linking exception)
