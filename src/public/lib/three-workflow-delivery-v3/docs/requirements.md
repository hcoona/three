...
is historical evidence in Git, delivery PR/Issue carriers, and the
[retained research and validation evidence](./README.md#historical-source-rule),
not evergreen requirements prose.
