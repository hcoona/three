...
> Source: [original record](https://github.com/hcoona/three/blob/b673ee27aab8553a4ee259bcaca87a197178463c/src/public/lib/asciidoctor-latexmath/DESIGN.md). This is not a new support promise
...
- 覆盖 `docs/research/latexmath-attribute-input.md` 列出的全部属性与选项，包括 `nocache`、`keep-artifacts` 等。
