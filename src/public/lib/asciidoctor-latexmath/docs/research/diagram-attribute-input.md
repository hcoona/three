...
> Source: [original record](https://github.com/hcoona/three/blob/b673ee27aab8553a4ee259bcaca87a197178463c/src/public/lib/asciidoctor-latexmath/AsciidoctorDiagramAttributes.md). This is not a new support promise
...
- **块级属性（Element Attribute）**：在方括号属性列表中声明，可进一步划分为 _位置属性（Positional Attribute）_、_命名属性（Named Attribute）_ 与 _选项（Option）_。
