...
- Purpose: ground non-functional conclusions and external constraints in the
  ...
  decisions from H-002, H-003, and H-004.
...
| IC-003 | User-level `.instructions.md` and Claude-rules files are loaded from the configured user instruction locations, whose documented default locations include `~/.copilot/instructions`, `~/.claude/rules`, and the instructions folder of the current VS Code profile. | Summary handoff behavior depends on the current instruction-loading model.                                                                                                                               | [VS Code custom instructions documentation](https://code.visualstudio.com/docs/copilot/customization/custom-instructions).                                                                                                |
