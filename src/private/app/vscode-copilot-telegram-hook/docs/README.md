...
| H-009 | [`h-009-human-requirement-2026-07-22-copilot-cli-idle-notifications.md`](./h-009-human-requirement-2026-07-22-copilot-cli-idle-notifications.md)           | Preserves the Copilot CLI attention and true-idle notification requirement.        | This establishes that intermediate main-agent pauses and subagent completion are spam, and that completion summaries should avoid an extra per-turn model call when possible.                                                                         |
...
| D-004 | [`../README.md`](../README.md)                                                             | Derived project overview                      | H-001 through H-009, D-001, D-002, D-005, and D-006                                                         | Convenient project entry point, but not the primary provenance ledger.                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| D-006 | [`copilot-cli-lifecycle-notifications-research.md`](./copilot-cli-lifecycle-notifications-research.md) | Derived technical research and design decision | H-009, the GitHub Copilot hooks reference, Copilot SDK event documentation, generated SDK event types, and extension documentation | Defines the CLI-specific distinction between turn boundaries, assistant idle, and session-wide quiescence, plus the zero-extra-model-call summary strategy. |
...
12. D-004 synchronizes the repository overview with the current derived
    specification set.
13. H-009 records the CLI-specific requirement to notify only for human
    attention or true session quiescence without subagent or intermediate-turn
    spam.
14. D-006 derives the Copilot CLI lifecycle architecture from H-009 and the
    current hook, SDK event, and extension contracts.
15. Future design and architecture documents should cite this file together with
