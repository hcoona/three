...
| ----- | ------------------------------------------------------------------------------------------ | --------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| D-001 | [`functional-requirements.md`](./functional-requirements.md)                               | Derived functional specification              | H-001, H-002, H-003, H-004, H-007, D-002, and D-003                                                         | Defines product-facing functional requirements after interpretation and normalization.                                                                                                                                                                       |
| D-002 | [`nonfunctional-and-constraints-research.md`](./nonfunctional-and-constraints-research.md) | Derived research and supporting specification | H-001 reference set, H-002, H-003, H-004, H-006, and H-007                                                  | Grounds research claims in the user-provided references from H-001 while recording later confirmed product decisions from H-002, H-003, H-004, H-006, and H-007.                                                                                             |
...
| D-004 | [`../README.md`](../README.md)                                                             | Derived project overview                      | H-001, H-002, H-003, H-004, H-005, H-006, H-007, D-001, D-002, and D-005                                    | Convenient project entry point, but not the primary provenance ledger.                                                                                                                                                                                       |
...
8. D-002 and D-003 research the H-001 reference set, with D-002 also
   incorporating the later confirmed decisions from H-002, H-003, H-004,
   H-006, and H-007 where needed, and D-003 incorporating the later
   verification from H-005 where needed.
9. D-001 derives the functional specification from H-001, H-002, H-003,
   H-004, H-007, and the research outputs.
10. D-005 records the later implementation-language evaluation using the
    H-series inputs, the research outputs, and the official documentation
    reviewed during that evaluation.
11. D-004 synchronizes the repository overview with the current derived
    specification set.
12. Future design and architecture documents should cite this file together with
