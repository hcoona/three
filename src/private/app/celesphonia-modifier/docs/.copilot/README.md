...
single-window experimental private WinUI Gold editor over released G6R4 using synthetic
implementation evidence and an explicit owner-affirmed compatibility limitation.
...
- `plans/atlas-v0-a0-approved-manifest-corpus-refresh.md` is the completed historical A0R3 route. It
  closed at verified shared `G0R3` on its no-candidate branch and grants no retry or A2 authority.
...
- `plans/atlas-v0-a2-workspace-preflight-refinement.md` is the released subordinate A2R5 correction
...
- `reviews/atlas-v0-a0-current-corpus-refresh-plan-review.md` binds the accepted A0R1 plan at verified
  shared `R0R1`.
- `reviews/atlas-v0-a0-current-corpus-refresh-governance-remediation-plan-review.md` binds the
...
- `reviews/atlas-v0-a0-approved-manifest-corpus-refresh-plan-review.md` binds the accepted A0R3 plan at
  verified shared `R0R3`.
- `reviews/atlas-v0-a0-approved-manifest-corpus-refresh-source-qualification.md` binds exact A0R3
  source at verified shared `S0R3`.
- `reviews/atlas-v0-a0-approved-manifest-corpus-refresh-completion.md` closes A0R3 at verified shared
  `G0R3` on its no-candidate branch without retry or A2 authority.
- `reviews/atlas-v0-a0-no-candidate-stage-diagnosis-plan-review.md` binds the accepted A0R4 plan at
  verified shared `R0R4`.
- `reviews/atlas-v0-a0-no-candidate-stage-diagnosis-source-qualification.md` binds exact A0R4 source at
...
- `reviews/atlas-v0-a2-released-a0-workspace-compatibility-plan-review.md` binds the completed A2R3
  correction plan.
- `reviews/atlas-v0-a2-released-a0-workspace-compatibility-release-gate.md` established A2R3
...
- `reviews/atlas-v0-a4-synthetic-structural-scanner-plan-review.md`, when present and verified as exact
...
- `plans/agent-workflow-institutionalization-plan.md` governs W0 execution only when its published
  plan-review record passes that plan's exact verification procedure.
- A verified, published `reviews/agent-workflow-institutionalization-plan-review.md` binds the
  accepted W0 plan and authorizes instruction writing. Presence alone conveys no authority.
- A verified, published `reviews/agent-workflow-institutionalization-release-gate.md` binds the
  accepted instruction candidate and establishes W0 completion. Presence alone is insufficient.

## Historical and supporting artifacts

- `plans/atlas-v0-a0-current-corpus-refresh-governance-remediation.md` is historical A0R1C1 evidence
  that excludes the later unauthorized execution result and closes A0R1 from its first authorized
  safe refusal.
