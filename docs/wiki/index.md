...
- [Workflow Delivery v3 AI Agent Handoff](./analyses/workflow-delivery/v3/agent-handoff.md) | Protected disabled runtime and native tooling, the rejected deleted-version primitive, preserved original tombstone, operator runbook, and blocked activation.
