...
- [Workflow Delivery v3 AI Agent Handoff](./analyses/workflow-delivery/v3/agent-handoff.md) | Current Publication/Finalizer design checkpoint, live Git inspection procedure, remaining implementation and activation gates, architecture guardrails, and engineering discipline.
