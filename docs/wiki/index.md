...
- [Workflow Delivery v3 AI Agent Handoff](./analyses/workflow-delivery/v3/agent-handoff.md) | Current local implementation checkpoint, delivery boundary, deferred units, architecture guardrails, and engineering discipline.
