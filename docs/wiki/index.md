...
- [Workflow Delivery v3 `hcoona-release-smoke-npm` First-Slice LLD](./analyses/workflow-delivery/v3/hcoona-release-smoke-npm-lld.md) | Exact first-slice contract for Governance v2, native npm profile acceptance, package-control proofs, one-Environment authorization, tarball staging, marker/Result terminal transport, current-DAG finalization, and auditable proving.
- [NuGet Smoke Second-Slice LLD](./analyses/workflow-delivery/v3/hcoona-release-smoke-github-packages-lld.md) | Proposed protected-main NuGet slice: native frozen Build, exact package and consumer evidence, one-shot HTTP publication, and separate native/Live admission gates.
...
- [Workflow Delivery v3 AI Agent Handoff](./analyses/workflow-delivery/v3/agent-handoff.md) | Completed independently audited real publication, protected ready Governance, exhausted dispatch authorization, and preserved first-failure/native/recovery boundaries.
- [NuGet Second-Slice Handoff](./analyses/workflow-delivery/v3/nuget-smoke-research-handoff.md) | Completed research, confirmed scope/trust/acceptance requirements, and ordered design delivery; no implementation or Live authorization.
