...
- [Workflow Delivery v3 AI Agent Handoff](./analyses/workflow-delivery/v3/agent-handoff.md) | Approved active-version lifecycle, five-probe acceptance revision, preserved v1 rejection and recovery boundary, operator runbook, and blocked activation.
