...
- [NuGet Second-Slice Research Handoff](./analyses/workflow-delivery/v3/nuget-smoke-research-handoff.md) | Historical smoke reuse candidates, retained package containers, current v3 gaps, unconfirmed requirements, and fresh-context workflow/discipline; research only, no implementation or Live authorization.
