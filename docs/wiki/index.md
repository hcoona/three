...
- [Workflow Delivery v3 AI Agent Handoff](./analyses/workflow-delivery/v3/agent-handoff.md) | Protected disabled runtime, completed legacy cleanup, native-acceptance readiness and authorization boundary, live Git inspection, and remaining activation gates.
