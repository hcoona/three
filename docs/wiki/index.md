...
- [Workflow Delivery v3 AI Agent Handoff](./analyses/workflow-delivery/v3/agent-handoff.md) | Protected ready Governance, supported npm metadata read-path correction before the unused proving dispatch, preserved native evidence and separate recovery boundary, and operator runbook.
