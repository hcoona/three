...
- [Workflow Delivery v3 AI Agent Handoff](./analyses/workflow-delivery/v3/agent-handoff.md) | Protected ready Governance, the first real run's pre-publication failure, transport-basename correction before one separately authorized new dispatch, and preserved native/recovery boundaries.
