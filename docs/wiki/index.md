...
- [Workflow Delivery v3 Governance Integration MLD](./analyses/workflow-delivery/v3/governance-integration-mld.md) | Native platform authority, same-revision control, first-slice repository-writer publisher TCB, permission isolation, and rollout acceptance.
...
- [Workflow Delivery v3 Release Delivery MLD](./analyses/workflow-delivery/v3/release-delivery-mld.md) | Request-local Repository Model input, channel identities, bounded Buddy GitHub Packages risk, qualification, authorization, replay, and remediation.
- [Workflow Delivery v3 `hcoona-release-smoke-npm` First-Slice LLD](./analyses/workflow-delivery/v3/hcoona-release-smoke-npm-lld.md) | Approved first-slice design covering destination/package locking, failure-preserving acceptance evidence, exact live-job permissions, npm witness checks, and direct Buddy cutover.
