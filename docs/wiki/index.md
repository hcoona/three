...
- [Workflow Delivery v3 AI Agent Handoff](./analyses/workflow-delivery/v3/agent-handoff.md) | Independently audited native v2 evidence, ready Governance and protected Activation delivery, one pending proving dispatch, preserved v1 rejection and separate recovery boundary, and operator runbook.
