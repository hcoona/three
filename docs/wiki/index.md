...
- [Workflow Delivery v3 AI Agent Handoff](./analyses/workflow-delivery/v3/agent-handoff.md) | Protected disabled runtime and native tooling, the authorized partial native run, exact storage-origin correction, operator runbook, and remaining activation gates.
