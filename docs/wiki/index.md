...
- [Workflow Delivery v3 AI Agent Handoff](./analyses/workflow-delivery/v3/agent-handoff.md) | Implemented active-only v2 tooling, protected-delivery and fresh five-probe acceptance gates, preserved v1 rejection and recovery boundary, operator runbook, and blocked activation.
