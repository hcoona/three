...
- [NuGet Smoke Second-Slice LLD](./analyses/workflow-delivery/v3/hcoona-release-smoke-github-packages-lld.md) | Protected-main NuGet design: native frozen Build, exact package and consumer evidence, one-shot HTTP publication, and separate native/Live admission gates.
