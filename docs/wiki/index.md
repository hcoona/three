...
- [Workflow Release Design Layering and Implementation Handoff Scope](./analyses/workflow-release-design-layering-and-handoff-scope.md) | Three-layer reading of the current design corpus, including what is already closed, which seam contracts still belong to design, and what lower-layer detail may be left to implementation. |
