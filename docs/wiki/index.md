...
- [Workflow Delivery v3 AI Agent Handoff](./analyses/workflow-delivery/v3/agent-handoff.md) | Protected disabled runtime, completed legacy cleanup, the bounded native-operator runbook, separate delivery/authorization gates, live Git inspection, and remaining activation work.
