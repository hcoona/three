...
- `concrete-kind`: current-scope examples include `nuget`, `snupkg`, `wheel`,
  `sdist`, `npm-package`, `browser-zip`, `rubygem`, `executable`, or `inno-setup`.
...
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `github-release-assets` | `primary-package/package/nuget`, `symbols/package/snupkg`, `primary-package/package/wheel`, `primary-package/package/sdist`, `primary-package/package/npm-package`, `primary-package/package/browser-zip`, `primary-package/package/rubygem`, `primary-binary/binary/executable`, `installer/installer/inno-setup` | One or more artifacts are required. Any mix of the allowed tuples may appear. Artifacts may come from one or more variants of the same project.                                                                                                                                              |
