...
2. Minimize your changes; only modify the necessary parts to implement the feature. Do not implement additional features unless explicitly requested by the user.
