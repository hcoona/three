...
```json
{
  ...
  "changed_files": [
    "src/private/app/vscode-copilot-telegram-hook/Commands/UserCommandService.cs",
    "src/private/app/vscode-copilot-telegram-hook/UserHookConfigurationManager.cs"
  ],
  "next_steps": [
