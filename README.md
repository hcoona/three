...
| Private app subtree      | `src/private/app/Directory.Build.props`                     | `RestorePackagesConfig=true`; `JsonSerializerIsReflectionEnabledByDefault=false`; `IsPackable=false`; `GitVersionBaseDirectory=$(MSBuildProjectDirectory)`; `DotNet.ReproducibleBuilds`=`2.0.2`; `Microsoft.CodeAnalysis.BannedApiAnalyzers`=`3.3.4`; `Microsoft.SourceLink.GitHub`=`8.0.0` | These settings are private-app-specific and intentionally do not flow to other source subtrees.                         |
| Public app subtree       | `src/public/app/Directory.Build.props`                      | `GitVersionBaseDirectory=$(MSBuildProjectDirectory)`; `DotNet.ReproducibleBuilds`=`1.2.25`; `Microsoft.CodeAnalysis.BannedApiAnalyzers`=`3.3.4`; `Microsoft.SourceLink.GitHub`=`8.0.0`                                                                                                      | These settings only apply to public apps; NBGV now comes from the repo-wide owner above.                                |
