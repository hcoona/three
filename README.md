...
| ------------------------ | --------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| Analyzer property        | `AnalysisLevel=latest`                              | `src/lab/Directory.Build.props`, `src/private/app/Directory.Build.props`, `src/public/app/Directory.Build.props`, `src/public/lib/Directory.Build.props`, `tests/Directory.Build.props`, `tests/public/Directory.Build.props` | root-wide default    | N2 should move this to the root `Directory.Build.props` and delete the subtree copies.                                                                                   | `tests/public` should keep its MSTest-specific additions plus its existing local suppressions/exceptions once the shared baseline lives at the root. |
