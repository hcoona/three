...
| Public app nested child  | `src/public/app/ImageOcclusionEditor/Directory.Build.props` | `RestorePackagesConfig=true`                                                                                                                                                                                                                                                                                                   | This subtree locally sets `RestorePackagesConfig=true`, and that setting does not flow to the whole public-app subtree. |
