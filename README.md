...
| Private app subtree    | `src/private/app/Directory.Build.props` | `JsonSerializerIsReflectionEnabledByDefault=false`; `GitVersionBaseDirectory=$(MSBuildProjectDirectory)`                                                                                                                                                                                                                                                                                             | These settings are private-app-specific and intentionally do not flow to other source subtrees.                                                 |
| Public app subtree     | `src/public/app/Directory.Build.props`  | `GitVersionBaseDirectory=$(MSBuildProjectDirectory)`                                                                                                                                                                                                                                                                                                                                                 | This subtree only keeps the app-local GitVersion base-directory override.                                                                       |
| Public library subtree | `src/public/lib/Directory.Build.props`  | `CentralPackageTransitivePinningEnabled=false`; `GitVersionBaseDirectory=$(MSBuildProjectDirectory)`; `IsAotCompatible` helper; `StyleCop.Analyzers`; NuGet metadata; linked `stylecop.json`                                                                                                                                                                                                         | These settings define the shared pack/library posture for `src/public/lib` only; packability itself now comes from `src/Directory.Build.props`. |
